...
struct PullToRefreshableScrollView<Content: View>: View {
        ...
        return VStack {
            ScrollView {
                ZStack(alignment: .top) {
                    ...
                    LazyVStack(alignment: .leading) { self.content }.alignmentGuide(.top, computeValue: { _ in (self.refreshing && self.frozen) ? -self.threshold : 0.0 })
